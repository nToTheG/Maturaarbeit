...
Ist \inlinemath{Q_\text{RL}} grösser, ist klar, dass die Drohne nach \inlinemath{\max{(S_\text{rechts}, S_\text{links})}} drehen muss. Im Fall, dass \inlinemath{Q_\text{OU}} grösser ist, wird die Drohne nach \inlinemath{\max{(S_\text{oben}, S_\text{unten})}} fliegen.
